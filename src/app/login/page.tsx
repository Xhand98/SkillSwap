                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/olvidar-contrasena" className="text-xs text-[#43159f] hover:underline">
                    ...
                    <div className="flex flex-col space-y-3 pt-2">
                        ...
                        <div className="relative my-2">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="bg-[#131213] px-2 text-white">or</span>
                            </div>
                        </div>

                        <button
                            type="button"
                            className="flex w-full items-center justify-center gap-2 rounded-md bg-white px-4 py-2 text-center font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
