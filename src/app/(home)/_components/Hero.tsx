...
export default function HeroSection() {
  return (
    <section className="relative flex mt-10 flex-col items-start justify-center w-full h-[65vh] px-4 sm:px-10">
      ...
      <div className="relative z-10 flex flex-col justify-center">
        ...
        <RectangleIcon
          width={45}
          height={45}
          className="absolute top-30 right-40 rotate-180 w-24 h-24 object-contain"
        />
        <RectangleIcon
          width={30}
          height={30}
          className="absolute top-50 left-0 rotate-0 w-24 h-24 object-contain"
        />
        <div className="flex items-center justify-center content-center gap-40 mt-10 pt-50 min-w-screen ">
