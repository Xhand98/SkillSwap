...
-- CREATE LOGIN api WITH PASSWORD = 'ContraSegura123!';
-- CREATE USER [apiUser] FOR LOGIN api
-- GRANT owner ON DATABASE::SkillSwapDB TO apiUser

-- create login for OwnerH WITH PASSWORD = 'PassUser123.123'
